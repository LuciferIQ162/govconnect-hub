              ...
              {!isLoading && (
                <div className="mt-6 pt-6 border-t border-border">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Found 12 relevant documents across 3 government databases. The query relates to inter-state water disputes with precedents from the Cauvery and Krishna tribunals.
                  </p>
                </div>
              )}
            </div>
